...
# gsmEarthMaterialExtension (Schema)

`usgin.bbr.geosci.gsmEarthMaterialExtension` *v0.1*
...
### examplegsmEarthMaterialExtensionMinimal
Minimal AlterationDescription instance — no required properties
#### json
```json
{
  "$comment": "Minimal AlterationDescription instance \u2014 no required properties"
}
...
$id: https://schemas.usgin.org/geosci-json/gsmEarthMaterialExtension/gsmEarthMaterialExtensionSchema.json
description: 'Detailed EarthMaterial description types: CompoundMaterialDescription,
...
* YAML version: [schema.yaml](https://usgin.github.io/geosci-json/build/annotated/bbr/geosci/gsmEarthMaterialExtension/schema.json)
* JSON version: [schema.json](https://usgin.github.io/geosci-json/build/annotated/bbr/geosci/gsmEarthMaterialExtension/schema.yaml)
...
[context.jsonld](https://usgin.github.io/geosci-json/_sources/gsmEarthMaterialExtension/context.jsonld)
...
* Path: `_sources/gsmEarthMaterialExtension`
