          ...
          properties:
            ...
            commissionDate:
              ...
              $comment: ISO 19108 TM_Instant aligned to W3C OWL-Time time:Instant
                ...
                / `inXSDDate` / `inXSDgYearMonth` / `inXSDgYear`, or a bare ISO 8601
                string as a convenience alias.
            ...
            location:
              ...
              $comment: External ISO 19115 CI_Responsibility - by-reference link or
                inline CDIF agentInRole
          ...
          properties:
            time:
              ...
              $comment: ISO 19108 TM_Period aligned to W3C OWL-Time time:ProperInterval
                ...
                is the OWL-Time object with `hasBeginning`/`hasEnd` (or the shortcut
                `hasBeginningDateTime`/`hasEndDateTime`). A two-element [startDate,
                endDate] array is accepted as a convenience alias (OGC code-sprint
                convention) but is not OWL-Time-canonical; consumers should prefer
                the object form.
      ...
      properties:
        properties:
          ...
          properties:
            ...
            sourceCollection:
              $ref: '#/$defs/SCLinkObject'
              $comment: External ISO 19156 SF_SamplingFeatureCollection - by-reference
                link
