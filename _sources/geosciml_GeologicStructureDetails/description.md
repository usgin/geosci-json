# GeoSciML GeologicStructureDetails

JSON Schema building block for the `GeologicStructureDetails` package of **GeoSciML 4.1**, encoding `«FeatureType»` classes as JSON-FG-compliant features and `«DataType»` / `«CodeList»` / `«Union»` classes per **OGC Best Practice 24-017r1** (*UML to JSON Encoding Rules*).
...
- `../geosciml_EarthMaterialDetails/schema.json#Mineral`
- `../geosciml_EarthMaterialDetails/schema.json#PhysicalDescription`
- `../geosciml_GSML_DataTypes/schema.json#GSML_LinearOrientation`
- `../geosciml_GSML_DataTypes/schema.json#GSML_PlanarOrientation`
- `../geosciml_GSML_DataTypes/schema.json#GSML_Vector`
- `../geosciml_GeologicEvent/schema.json#GeologicEvent`
- `../geosciml_GeologicStructure/schema.json#ContactAbstractDescription`
- `../geosciml_GeologicStructure/schema.json#FoldAbstractDescription`
- `../geosciml_GeologicStructure/schema.json#Foliation`
- `../geosciml_GeologicStructure/schema.json#FoliationAbstractDescription`
- `../geosciml_GeologicStructure/schema.json#GeologicStructure`
- `../geosciml_GeologicStructure/schema.json#ShearDisplacementStructureAbstractDescription`
...
- [Minimal](examples/exampleGeologicStructureDetailsMinimal.json) — bare valid instance.
- [Complete](examples/exampleGeologicStructureDetailsComplete.json) — fully-populated example.

## Source

- UML: `geosciml4.1.xmi`, package `GeologicStructureDetails`.
